...
{
    public class GenericRepository<Entity>(FlowCastContext context) : IGenericRepository<Entity> where Entity : class
    {
        protected readonly FlowCastContext _context = context;
